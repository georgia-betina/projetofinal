package br.univille.projetofinal.api;
...
public class ClienteControllerAPI {
  ...
  //  @ApiOperation(value = "Endpoint que retorna todos os dados dos clientes")
    ...
    public ResponseEntity<Cliente> update(@PathVariable long id, @RequestBody Cliente clienteAlt){
        ...
        clienteAntigo.setCPF(clienteAlt.getCPF());
        clienteAntigo.setDataCadastro(clienteAlt.getDataCadastro());
        clienteAntigo.setJaComprou(clienteAlt.isJaComprou());
